...
const ExpenseTable: React.FC<ExpenseTableProps> = ({
  expenses = [
    ...
    },
    {
      ...
      description: "Reembolso bolo para reunião",
      amount: 31.9,
      status: "approved",
      date: "2024-05-13",
      purpose: "Reembolso",
      ...
      receipt:
        "https://images.unsplash.com/photo-1578662996442-48f1e1e94f95?w=400&q=80",
    },
    {
      id: "4",
      name: "Lutcho Giannini",
      description: "Envio de duas amostras de mel",
      amount: 15.16,
      status: "rejected",
      date: "2024-03-26",
      purpose: "Reembolso",
